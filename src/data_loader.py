...
def merge_features(traffic, timestamps, config, train_end=None):
    ...
    # 2. Fetch Holidays (support multi-year if data spans year boundary)
    ...
    # 5. Normalize Weather (Z-Score using TRAIN-ONLY statistics to prevent leakage)
...
def get_dataloaders(config):
    ...
    # Merge Features (Using Normalized Traffic, train_end for weather normalization)
